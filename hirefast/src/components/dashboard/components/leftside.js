...
export default function Leftside({ current, setRight, right, left, setLeft }) {
  ...
  return (
    <div className="md:min-h-screen max-h-20 h-20 bg-[#141531] flex flex-col justify-between items-center md:h-full w-full text-white">
